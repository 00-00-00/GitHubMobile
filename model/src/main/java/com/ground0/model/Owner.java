...
@JsonInclude(JsonInclude.Include.NON_NULL) @JsonPropertyOrder({
   ...
   * @return The login
   */
  @JsonProperty("login") public String getLogin() {
    return login;
  }
   ...
   */
  @JsonProperty("login") public void setLogin(String login) {
    this.login = login;
  }
   ...
   */
  @JsonProperty("avatar_url") public String getAvatarUrl() {
    return avatarUrl;
  }
   ...
   */
  @JsonProperty("avatar_url") public void setAvatarUrl(String avatarUrl) {
   ...
   */
  @JsonProperty("gravatar_id") public String getGravatarId() {
    return gravatarId;
  }
   ...
   */
  @JsonProperty("gravatar_id") public void setGravatarId(String gravatarId) {
   ...
   * @return The htmlUrl
   */
  @JsonProperty("html_url") public String getHtmlUrl() {
    return htmlUrl;
  }
   ...
   */
  @JsonProperty("html_url") public void setHtmlUrl(String htmlUrl) {
   ...
   */
  @JsonProperty("followers_url") public String getFollowersUrl() {
    return followersUrl;
  }
   ...
   */
  @JsonProperty("followers_url") public void setFollowersUrl(String followersUrl) {
   ...
   */
  @JsonProperty("following_url") public String getFollowingUrl() {
    return followingUrl;
  }
   ...
   */
  @JsonProperty("following_url") public void setFollowingUrl(String followingUrl) {
   ...
   * @return The gistsUrl
   */
  @JsonProperty("gists_url") public String getGistsUrl() {
    return gistsUrl;
  }
   ...
   */
  @JsonProperty("gists_url") public void setGistsUrl(String gistsUrl) {
   ...
   */
  @JsonProperty("starred_url") public String getStarredUrl() {
    return starredUrl;
  }
   ...
   */
  @JsonProperty("starred_url") public void setStarredUrl(String starredUrl) {
   ...
   */
  @JsonProperty("subscriptions_url") public String getSubscriptionsUrl() {
   ...
   */
  @JsonProperty("subscriptions_url") public void setSubscriptionsUrl(String subscriptionsUrl) {
   ...
   */
  @JsonProperty("organizations_url") public String getOrganizationsUrl() {
   ...
   */
  @JsonProperty("organizations_url") public void setOrganizationsUrl(String organizationsUrl) {
   ...
   * @return The reposUrl
   */
  @JsonProperty("repos_url") public String getReposUrl() {
    return reposUrl;
  }
   ...
   */
  @JsonProperty("repos_url") public void setReposUrl(String reposUrl) {
   ...
   */
  @JsonProperty("events_url") public String getEventsUrl() {
    return eventsUrl;
  }
   ...
   */
  @JsonProperty("events_url") public void setEventsUrl(String eventsUrl) {
   ...
   */
  @JsonProperty("received_events_url") public String getReceivedEventsUrl() {
   ...
   */
  @JsonProperty("received_events_url") public void setReceivedEventsUrl(String receivedEventsUrl) {
   ...
   */
  @JsonProperty("site_admin") public Boolean getSiteAdmin() {
    return siteAdmin;
  }
   ...
   */
  @JsonProperty("site_admin") public void setSiteAdmin(Boolean siteAdmin) {
